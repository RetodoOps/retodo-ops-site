...
function jobFinancialSnapshot(){
  ...
  return {clientValue:matched?roundMoney(clientValue):null,clientCurrency:project?.currency||'EUR',supplierCost:supplierCost==null?null:roundMoney(supplierCost),supplierCurrency:poCost!=null?purchaseOrder.currency:supplierCurrency};
}
