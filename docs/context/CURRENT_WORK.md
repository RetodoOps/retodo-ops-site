...
Current branch: `dev/lightweight-continuity-clean`
Starting HEAD: `c5b60306635fb37803ebe145fe8f139bcb580614` (live main)
Latest durable checkpoint: the commit containing this configuration on `dev/lightweight-continuity-clean`; resolve its SHA from the remote branch tip.
Build: `057` — unchanged
...
- Created a clean branch from live main, carrying only these two files from
  dev/continuity-lightweight at 46301fedc398441cec102c966d4e7e990cab01b0.
- Verified the complete diff against main contains exactly the two listed files.
...
- GitHub implementation: documentation-only checkpoint on the non-main
  ...
  Parent is current main c5b60306635fb37803ebe145fe8f139bcb580614;
  no unrelated task-branch commits or file changes are included.
